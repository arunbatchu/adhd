...
description: The diagnostic process end to end - who can diagnose, what an evaluation involves, how to prepare, how to read the report, and what a diagnosis does and does not mean
...
<details markdown="1">
<summary>Anatomy of a Thorough Evaluation</summary>
Type: workflow
**sim-id:** evaluation-anatomy-map<br/>
**Library:** p5.js<br/>
**Status:** Specified
